...
const BODY_CLASS_NAME = 'ayui-modal-open'
const CONTAINER_CLASS_NAME = 'ayui-modal-open-for-container'
const ayui_VIEW_BOX_ELEMENT = '#ayui_view_box_body'
  ...
  methods: {
    ...
    addModalClassName () {
      ...
      if (this.getLayout() === 'VIEW_BOX') {
        ...
        dom.addClass(document.querySelector(ayui_VIEW_BOX_ELEMENT), CONTAINER_CLASS_NAME)
      }
    },
    removeModalClassName () {
      if (this.getLayout() === 'VIEW_BOX') {
        dom.removeClass(document.body, BODY_CLASS_NAME)
        dom.removeClass(document.querySelector(ayui_VIEW_BOX_ELEMENT), CONTAINER_CLASS_NAME)
      }
    }
  },
  beforeDestroy () {
