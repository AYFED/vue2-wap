<template>
  <div>
    <group label-width="4.5em" label-margin-right="2em" label-align="right">
      ...
      <x-input title="上<i class='ayui-blank-half'></i>报<i class='ayui-blank-half'></i>人" v-model="value1"></x-input>
...
<script>
  import { GroupTitle, Group, Cell, XInput, Selector, PopupPicker, Datetime, XNumber, XAddress, XTextarea, XSwitch } from '@/components'
