    ...
    <div style="margin: 10px;overflow: hidden;" v-for="item in list">
      <masker style="border-radius: 2px;">
        ...
        <div slot="content" class="m-title">
          {{item.title}}
          <br/>
          <span class="m-time">2017-03-18</span>
        </div>
      </masker>
    </div>
    <div style="margin: 10px;overflow: hidden;">
      <masker style="border-radius: 2px;" color="dcdcdc" :opacity="0.5">
        <div class="m-img" style="background-image:url(https://images1.aoyou.com/productlist/201712/24bbvr06173003.jpg)"></div>
        <div slot="content" class="m-title">
          ayui
          <br/>
          <span class="m-time">2017-03-18</span>
