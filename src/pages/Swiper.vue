<template>
  <div>
    ...
    <br>
    <p style="margin-left: 20px;">current index: {{demo01_index}}</p>
    <br>
    ...
    <br>
    <p style="margin-left: 20px;">current index:{{ swiperItemIndex }}</p>
    <br>
    ...
    <br>
    <p style="margin-left: 20px;"> current index: {{demo05_index}}</p>
    <br>
    <x-button @click.native="demo05_onLoad(1)" type="primary">Load list1</x-button>
    <x-button @click.native="demo05_onLoad(2)" type="primary">Load list2</x-button>
    ...
    <p style="margin-left: 20px;">current index: {{demo06_index}}</p>
...
const baseList = [{
  url: 'javascript:',
  img: 'https://images1.aoyou.com/productlist/201711/tl0f8230135501.jpg',
  title: '送你一朵fua'
}, {
  url: 'javascript:',
