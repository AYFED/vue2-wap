      ...
      <popup v-model="show" @on-hide="log('hide')" @on-show="log('show')">
        <div class="popup0">
          <group>
            ...
            <x-switch title="显示 Toast" v-model="showToast" prevent-default @on-click="onClick"></x-switch>
          </group>
        </div>
      </popup>
    </div>
...
<script>
import { Popup, Group, Cell, XButton, XSwitch, Toast, XAddress } from '@/components'
