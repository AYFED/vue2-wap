<template>
  <div>
    ...
    <group title="验证码" class="ayui-cells_form">
      <x-input title="验证码" class="ayui-cell_vcode">
        <img slot="right" class="ayui-vcode-img" src="https://i.loli.net/2017/09/18/59bf7f32425d5.jpg">
      </x-input>
      <x-input title="发送验证码" class="ayui-vcode">
