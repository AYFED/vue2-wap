<template>
    <div>
        ...
        <div v-transfer-dom>
            <actionsheet v-model="show8" :menus="menus8" @on-click-menu="demo8doClose" :close-on-clicking-mask="false"
...
<script>
  import { Actionsheet, Group, Toast, XSwitch } from '@/components';
