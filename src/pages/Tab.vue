<template>
  <div>
    ...
    <div style="width: 100%;overflow:scroll;-webkit-overflow-scrolling:touch;" id="demotab">
    ...
    <div>
      ...
      <swiper v-model="index" height="100px" :show-dots="false">
        <swiper-item v-for="(item, index) in list2" :key="index">
          <div class="tab-swiper ayui-center">{{item}} Container</div>
        </swiper-item>
      </swiper>
    </div>
    ...
    <div class="box">
      ...
      <x-button @click.native="next" type="primary" style="width: 80%;">Active next current: {{index}}</x-button>
      <x-button @click.native="prev" type="primary" style="width: 80%;">Active prev current: {{index}}</x-button>
    </div>

    <br/>
    <br/>
    <tab :line-width="2">
      <tab-item :selected="demo3 === item" v-for="(item, index) in list3" :class="{'ayui-1px-r': index===0}" @click="demo3 = item" :key="index">{{item}}</tab-item>
    </tab>
    <br/>
    <br/>
    <br/>
