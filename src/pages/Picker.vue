<template>
  <div>
    ...
    <x-button @click.native="setData1" type="primary" class="ayui-fix-button-long"> {{ $t('Set value to') }} ["USA", "usa002", "0005"]</x-button>
    <x-button @click.native="setData2" type="primary" class="ayui-fix-button-long"> {{ $t('Set value to') }} ["china", "china002", "gz"]</x-button>
