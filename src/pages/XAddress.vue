<template>
  <div>
    ...
    <div style="padding: 15px;">
      ...
      <x-button type="primary" @click.native="doShowAddress" style="width: 80%;">单独控制显示(2s后关闭)</x-button>
    </div>
    ...
    <div style="padding: 0 15px;">
      <x-button type="primary" @click.native="changeData" style="width: 80%;">改变数据（通过 id）</x-button>
      <x-button type="primary" @click.native="changeDataByLabels" style="width: 80%;">改变数据（通过文字值）</x-button>
      <x-button type="primary" @click.native="changeDataByLabels2" style="width: 80%;">改变数据（两级）</x-button>
    </div>
    <br/>
...
<script>
import { Group, XAddress, XButton, Cell } from '@/components'
