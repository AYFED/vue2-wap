<template>
  <div>
    ...
    <box gap="10px 10px">
      ...
      <flexbox>
        <flexbox-item>
          <x-button type="default" style="width: 100%;">default</x-button>
        </flexbox-item>
        <flexbox-item>
          <x-button type="primary" style="width: 100%;">primary</x-button>
        </flexbox-item>
        <flexbox-item>
          <x-button type="warn" style="width: 100%;">Delete</x-button>
        </flexbox-item>
      </flexbox>
    </box>
  </div>
