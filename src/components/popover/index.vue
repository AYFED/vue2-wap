...
export default {
  ...
  computed: {
    arrowClass () {
      return {
        'ayui-popover-arrow': true,
        'ayui-popover-arrow-up': this.placement === 'bottom',
        'ayui-popover-arrow-right': this.placement === 'left',
        'ayui-popover-arrow-left': this.placement === 'right',
        'ayui-popover-arrow-down': this.placement === 'top'
      }
    }
  }
}
