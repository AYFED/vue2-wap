<template>
  ...
  @mouseup="end"
  @touchcancel="end">
    <div class="ayui-swipeout-button-box ayui-swipeout-button-box-left" :style="leftButtonBoxStyle" v-show="distX >= 0">
      <slot name="left-menu"></slot>
    </div>
    <div class="ayui-swipeout-button-box" :style="rightButtonBoxStyle" v-show="distX <= 0">
      <slot name="right-menu"></slot>
    </div>
    <div class="ayui-swipeout-content" :style="styles" @mousedown="onContentClick" @touchstart="onContentClick" ref="content">
  ...
  methods: {
    ...
    setOffset (x, animated = false, force) {
      ...
      if (animated && this.target) {
        this.target && this.target.classList.add('ayui-swipeout-content-animated')
        var cb = (function (self, target) {
          return function () {
            target.classList.remove('ayui-swipeout-content-animated')
