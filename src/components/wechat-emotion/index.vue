<template>
  <div class="ayui-emotion"><slot style="display:none;"></slot></div>
</template>
...
export default {
  ...
  mounted () {
    ...
    let imgHTML = ''
    if (!this.isGif) {
      imgHTML = `<span class="ayui-static-emotion" style="background:url(https://res.wx.qq.com/mpres/htmledition/images/icon/emotion/default218877.gif) ${this.backgroundPositionX}px 0;"></span>`
    } else {
