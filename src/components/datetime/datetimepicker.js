...
const TEMPLATE = `<div class="dp-container">
  <div class="dp-header">
    <div class="dp-item dp-left ayui-datetime-cancel" data-role="cancel">cancel</div>
    <div class="dp-item ayui-datetime-clear" data-role="clear"></div>
    <div class="dp-item dp-right ayui-datetime-confirm" data-role="confirm">done</div>
  </div>
...
DatetimePicker.prototype = {
  ...
  _show (newValueMap) {
    ...
    if (this.renderInline) {
      self.container.classList.add('ayui-datetime-view')
    }
  ...
  show (value) {
    ...
    if (config.isOneInstance) {
      if (document.querySelector('#ayui-datetime-instance')) {
        return
      }
      self.willShow = true
    }
    ...
    if (self.container) {
      ...
      if (config.isOneInstance) {
        container.id = 'ayui-datetime-instance'
      }
