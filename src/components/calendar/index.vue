<template>
  <div class="ayui-calendar">
    <cell
      :title="title"
      primary="content"
      @click.native="onClick"
      :is-link="!readonly">
      <span class="ayui-cell-placeholder" v-if="shouldShowPlaceholder">{{ placeholder }}</span>
      <span class="ayui-cell-value" v-if="!shouldShowPlaceholder">{{ displayFormat(value, getType(value)) }}</span>
    </cell>
...
<style lang="less">
@import '../../styles/ayui/base/fn';
@import '../../styles/ayui/base/mixin/setOnepx.less';

.ayui-calendar {
  position: relative;
  &:before {
    .setTopLine(@ayuiCellBorderColor);
    left: @ayuiCellGapH;
  }
}
</style>
